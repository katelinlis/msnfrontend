...
export class MainController {
  ...
  async Login(@Req() request: RequestCoockie) {
    ...
    return {
      ...
      description: `Страница авторизации в соц сети Modern Social`,
      keywords: `Войти, Авторизоваться, Зарегистрироваться,Стать участником,список пользователей, участники соц сети, открытая социальная сеть, свободная социальная сеть`,
    };
  }
}
